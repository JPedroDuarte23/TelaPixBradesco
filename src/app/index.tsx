...
export default function Index() {
  return (
    <View className="flex-1">
      <View className="bg-pink-500 h-[76] pt-8 pl-4 flex flex-row gap-8 items-center">
      ...
      <ScrollView showsVerticalScrollIndicator={false} className="flex-1 overflow-scroll">
        ...
        <View className="flex flex-col mt-[-108] mx-6">

          <Text className="text-white font-semibold text-2xl mb-6">Como você quer transferir?</Text>
        ...
        <View className="bg-gray-200 h-full px-5 pb-12 mt-[40]">
          <View className="flex flex-wrap flex-row gap-1 justify-between mt-[-40]">
            <Button variant="list" label="Extrato Pix">
              <Image className="w-7 h-7" source={require("@/assets/icons/extractIcon.png")} />
            </Button>
            <Button variant="list" label="Minhas chaves Pix">
              <Image className="w-7 h-7" source={require("@/assets/icons/keyIcon.png")} />
            </Button>
            <Button variant="list" label="Gerenciar contatos">
              <Image className="w-7 h-7" source={require("@/assets/icons/starIcon.png")} />
            </Button>
            <Button variant="list" label="Limites Pix">
              <Image className="w-7 h-7" source={require("@/assets/icons/settingsIcon.png")} />
            </Button>
            <Button variant="list" label="Pix agendados">
              <Image className="w-7 h-7" source={require("@/assets/icons/calendarIcon.png")} />
            </Button>
            <Button variant="list" label="Notificações">
              <Image className="w-7 h-7" source={require("@/assets/icons/notificationIcon.png")} />
            </Button>
            <Button variant="list" label="Contestações">
              <Image className="w-7 h-7" source={require("@/assets/icons/contestationIcon.png")} />
            </Button>
          </View>
        </View>
      </ScrollView>
